    ...
    <div class="app-main">
      ...
      <div style="text-align: center">
        <el-button-group style="margin: 0 auto">
          <el-button type="info" icon="el-icon-arrow-left" @click="toDistractorGeneration"
            >上一步</el-button
          >
          <el-button type="primary" @click="save"
            >入库 <i class="el-icon-arrow-right el-icon--right"></i
          ></el-button>
        </el-button-group>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      async save() {
        ...
        try{
            let res = await saveData({"upload":true})
            if(res.code===200){
                this.$message({
                    message: `试题入库成功`,
                    type: "success",
