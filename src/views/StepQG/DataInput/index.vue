  ...
  <div>
    <el-card>
      <div slot="header" class="clearfix">
        <label style="font-size: x-large">文件上传</label>
      </div>
      <el-form :model="form" v-loading="listLoading">
        ...
        <el-form-item >
          ...
          <el-upload
            ...
            action=""
            :limit="limitNum"
            accept=".ppt, .pptx, .pdf, jpg, .jpeg, .png, .gif, .bmp, .PPT, .PPTX, .PDF, .JPG, .JPEG, .PNG, .GIF, .BMP,"
            list-type="text"
            :file-list="fileList"
            :auto-upload='false'
          ...
          >
            <div style="margin-left: 100px" slot="tip" class="el-upload__tip">只能上传ppt/pptx文件，且不超过10MB</div>
